...
export const Register = () => {
  ...
  <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <div>
        <label className="block text-sm font-medium leading-6 text-gray-900">Név</label>
        <div className="mt-2">
          <input {...register("name")} id="name" name="name" type="text"  className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"/>
      ...
      <div>
        <div className="flex items-center justify-between">
          <label className="block text-sm font-medium leading-6 text-gray-900">Szerepkör</label>
        </div>
        <div className="mt-2">
          <select {...register("roleName")} id="roleName" name="roleName"  className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            <option value="Felhasznalo">Felhasználó</option>
            <option value="Konyvelo">Könyvelő</option>
          </select>
          {errors.roleName && <span className='text-red-600'>{errors.roleName.message}</span>}
        </div>
      </div>

      <div>
        <button type="submit" className="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 mb-3 disabled:bg-indigo-200" disabled={!isValid}>Regisztráció</button>
    ...
    <p className="mt-5 text-center text-sm text-gray-500">
      Van már fiókod?
      <Link to="/bejelentkezes" className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Bejelentkezés</Link>
    </p>
  </div>
</div>
  )
